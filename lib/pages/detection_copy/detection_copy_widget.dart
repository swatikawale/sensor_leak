...
import 'detection_copy_model.dart';
export 'detection_copy_model.dart';

class DetectionCopyWidget extends StatefulWidget {
  const DetectionCopyWidget({super.key});

  @override
  State<DetectionCopyWidget> createState() => _DetectionCopyWidgetState();
}

class _DetectionCopyWidgetState extends State<DetectionCopyWidget>
    with TickerProviderStateMixin {
  late DetectionCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetectionCopyModel());
