...
import 'detection5_light_model.dart';
export 'detection5_light_model.dart';

class Detection5LightWidget extends StatefulWidget {
  const Detection5LightWidget({super.key});

  @override
  State<Detection5LightWidget> createState() => _Detection5LightWidgetState();
}

class _Detection5LightWidgetState extends State<Detection5LightWidget>
    with TickerProviderStateMixin {
  late Detection5LightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Detection5LightModel());
