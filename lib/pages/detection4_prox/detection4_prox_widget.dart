...
import 'detection4_prox_model.dart';
export 'detection4_prox_model.dart';

class Detection4ProxWidget extends StatefulWidget {
  const Detection4ProxWidget({super.key});

  @override
  State<Detection4ProxWidget> createState() => _Detection4ProxWidgetState();
}

class _Detection4ProxWidgetState extends State<Detection4ProxWidget>
    with TickerProviderStateMixin {
  late Detection4ProxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Detection4ProxModel());
